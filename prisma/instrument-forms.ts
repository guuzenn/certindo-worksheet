...
export const instrumentForms: InstrumentFormSeed[] = [
  ...
  { code: 'CCI-KAL-FOM-010', name: 'Pressure Gauge', sheet: 'Pressure Gauge', workbook: earlyWorkbookPath },
  ...
  { code: 'CCI-KAL-FOM-058', name: 'Digital Pressure (FOM-058)', sheet: 'Digital Pressure', workbook: earlyWorkbookPath, needsTemplateReview: true },
  { code: 'CCI-KAL-FOM-059', name: 'Thermometer Digital', sheet: 'Thermometer Digital', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-060', name: 'Refractometer', sheet: 'Refractometer 03', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-061', name: 'Centrifuge (Timer)', sheet: 'Centrifuge (Timer) 02', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-062', name: 'Hydrometer', sheet: 'Hydrometer 02', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-063', name: 'Stroboscope', sheet: 'Stroboscope 02', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-064', name: 'Termometer Gelas', sheet: 'Termometer Gelas 03', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-065', name: 'Tachometer', sheet: 'Tachometer 02', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-066', name: 'Density Meter', sheet: 'Density Meter 03', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-067', name: 'Buret Digital', sheet: 'Buret Digital 03', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-068', name: 'Mikropipet', sheet: 'Mikropipet 03', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-069', name: 'PH Meter', sheet: 'PH Meter 03', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-071', name: 'Force Gauge', sheet: 'Force Gauge 05', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-072', name: 'Push Pull', sheet: 'Push Pull 06', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-073', name: 'Pull Test Kit', sheet: 'Pull Test Kit 05', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-074', name: 'Texture Analyzer', sheet: 'Texture Analyzer 05', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-075', name: 'Moisture Analyzer', sheet: 'Moisture Analyzer 04', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-076', name: 'Moisture Meter', sheet: 'Moisture Meter 01', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-077', name: 'Infrared Thermometer', sheet: 'Infrared Thermometer 03', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-078', name: 'Salinity Refractometer', sheet: 'Salinity Refractometer 02', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-079', name: 'TDS Meter', sheet: 'TDS Meter 02', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-080', name: 'Torque Wrench', sheet: 'Torque Wrench 04', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-081', name: 'Torque Screwdriver', sheet: 'Torque Screwdriver 04', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-082', name: 'Torque Meter', sheet: 'Torque Meter 05', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-084', name: 'Dispensette', sheet: 'Dispensete 03', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-085', name: 'Climatic Chamber', sheet: 'Climatic Chamber 03', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-087', name: 'Dry Block', sheet: 'Dry Block 04', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-088', name: 'Ruler', sheet: 'Ruler 02', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-089', name: 'Temperature Data Logger', sheet: 'Temperature Data Logger 05', workbook: earlyWorkbookPath },
  { code: 'CCI-KAL-FOM-090', name: 'Viscometer', sheet: 'Viscometer 02', workbook: earlyWorkbookPath, omitFields: ['identityNumber'] },
  { code: 'CCI-KAL-FOM-091', name: 'Spektrofotometer', sheet: 'Spektrofometer 02', workbook: earlyWorkbookPath, omitFields: ['identityNumber'] },
  { code: 'CCI-KAL-FOM-094', name: 'Volume Flowrate (Direct)', sheet: 'Volume FLowrate(Direct) 02', workbook: earlyWorkbookPath, omitFields: ['identityNumber'] },
  {
  ...
  { code: 'CCI-KAL-FOM-099', name: 'Conductivity Meter', sheet: 'Condutictivity Meter', omitFields: ['identityNumber'], needsTemplateReview: true },
  { code: 'CCI-KAL-FOM-100', name: 'Hot Plate Stirrer', sheet: 'Hot Plate Stirrer', omitFields: ['identityNumber'] },
  { code: 'CCI-KAL-FOM-101', name: 'Bejana Ukur', sheet: 'Bejana Ukur', omitFields: ['identityNumber'] },
  { code: 'CCI-KAL-FOM-102', name: 'Magnehelic', sheet: 'Magnehelic' },
  ...
  { code: 'CCI-KAL-FOM-106', name: 'Liquid Bath', sheet: 'Liquid Bath' },
  { code: 'CCI-KAL-FOM-109', name: 'Timbangan Jembatan', sheet: 'Timbangan Jembatan', omitFields: ['identityNumber'] },
  { code: 'CCI-KAL-FOM-111', name: 'Turbidity Meter', sheet: 'Turbidity Meter', omitFields: ['identityNumber'] },
  { code: 'CCI-KAL-FOM-112', name: 'Chlorine Meter', sheet: 'Chlorine Meter' },
  { code: 'CCI-KAL-FOM-113', name: 'Zahn Cup', sheet: 'Zahn Cup', omitFields: ['identityNumber', 'capacity', 'resolution'] },
  { code: 'CCI-KAL-FOM-114', name: 'AW Meter', sheet: 'AW Meter', omitFields: ['identityNumber'] },
  { code: 'CCI-KAL-FOM-115', name: 'Coating Thickness Meter', sheet: 'Coating Thickness Meter' },
  { code: 'CCI-KAL-FOM-116', name: 'Mixing Machine', sheet: 'Mixing Machine', omitFields: ['identityNumber'] },
  ...
  { code: 'CCI-KAL-FOM-122', name: 'Temperature Gauge', sheet: 'Temperature Gauge', omitFields: ['identityNumber'] },
  { code: 'CCI-KAL-FOM-125', name: 'Mass Flowmeter', sheet: 'Mass Flowmeter', omitFields: ['identityNumber'] },
  { code: 'CCI-KAL-FOM-129', name: 'Totalizer Flowmeter', sheet: 'Totalizer Flowmeter', omitFields: ['identityNumber'] },
  { code: 'CCI-KAL-FOM-130', name: 'Meter BBM (Volumetrik)', sheet: 'Meter BBM (Volumetrik)', omitFields: ['identityNumber'] },
  { code: 'CCI-KAL-FOM-134', name: 'Furnace', sheet: 'Furnace' },
  {
    code: 'CCI-KAL-FOM-135', name: 'Pin Gauge', sheet: 'Pin Gauge', omitFields: ['resolution'],
    additionalFields: dimensionalAdditionalFields,
    measurementTables: [{
  ...
  { code: 'CCI-KAL-FOM-140', name: 'Metal Detector', sheet: 'Metal Detector', omitFields: ['capacity', 'resolution'] },
  { code: 'CCI-KAL-FOM-141', name: 'Magnet atau Listrik', sheet: 'Magnet atau Listrik', omitFields: ['identityNumber'] },
  { code: 'CCI-KAL-FOM-142', name: 'Gauss atau Tesla Meter', sheet: 'Gauss atau Tesla Meter', omitFields: ['identityNumber'] },
  { code: 'CCI-KAL-FOM-143', name: 'Magnet Trap', sheet: 'Magnet Trap', omitFields: ['identityNumber', 'resolution'] },
  { code: 'CCI-KAL-FOM-144', name: 'Metal Test Piece', sheet: 'Metal Test Piece' },
  { code: 'CCI-KAL-FOM-146', name: 'X-Ray', sheet: 'X-RAY', omitFields: ['identityNumber', 'capacity', 'resolution'] },
  { code: 'CCI-KAL-FOM-147', name: 'Biosafety Cabinet', sheet: 'Biosafety Cabinet', omitFields: ['identityNumber'] },
  { code: 'CCI-KAL-FOM-148', name: 'RPM Meter', sheet: 'RPM Meter' },
  { code: 'CCI-KAL-FOM-149', name: 'Digital Pressure', sheet: 'Digital Pressure' },
  { code: 'CCI-KAL-FOM-150', name: 'Tangki Ukur', sheet: 'Tangki Ukur' },
  {
