...
describe('sortInstrumentForms', () => {
  it('mengurutkan template berdasarkan nomor FOM lalu revisi terbaru', () => {
    const options: CalibrationOptions['instrumentForms'] = [
      ...
      { id: '28r4', code: 'CCI-KAL-FOM-028', name: 'Timbangan', revision: '04', fields, additionalFields: [], measurementTables: [] },
      { id: '10', code: 'CCI-KAL-FOM-010', name: 'Pressure Gauge', revision: '00', fields, additionalFields: [], measurementTables: [] },
      { id: '28r5', code: 'CCI-KAL-FOM-028', name: 'Timbangan', revision: '05', fields, additionalFields: [], measurementTables: [] },
    ];
